...
<div>
    <form action="/studentModifying" method="post">
        ...
        <div class="container buttons">
            <input type="text" class="btn one" placeholder="Фамилия" value="${student.surname}" name="surname">
            <input type="text" class="btn" placeholder="Имя" value="${student.name}" name="name">
        </div>
        <div class="container buttons fields mt30">
            <input type="text" class="btn one" placeholder="Группа" value="${student.group}" name="group">
            <input type="text" class="btn" placeholder="Дата поступления" id="datepicker" autocomplete="off"
                   value="<f:formatDate value="${student.date}" pattern="dd/MM/yyyy"/>" name="date">
        </div>

        <div class="container buttons1">
            <%--  <a href="#" class="btn1">ПРИМЕНИТЬ</a>--%>
            <input type="submit" value="ПРИМЕНИТЬ" class="btn1">
        </div>
    </form>
