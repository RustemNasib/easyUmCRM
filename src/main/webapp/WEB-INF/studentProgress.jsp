  ...
  <header id="header" class="header">
    ...
    <div class="container">
      <table class="table" style="float: left;">
        ...
        <tr>
          <td class="td">Управление проектами</td>
          <td class="td">5</td>
        </tr>
        <tr>
          <td class="td">Основы дискретной математики</td>
          <td class="td">4</td>
        </tr>
        </tbody>
      </table>
      ...
      <div class="but" style="float: right;">
        <ul class="bot">
          ...
          <a class="text" href="#">ПРИМЕНИТЬ</a>

        </ul>
        <ul>
          <li class="li6">Средняя оценка за семестр: 4,8 балла</li>
        </ul>
      </div>
    </div>
  </header>
